...
export default class Search {
    ...
    sendRequest() {
      axios.post('/search', {searchTerm: this.inputField.value, _csrf: this._csrf}).then(response => {
    ...
    renderResultsHTML(posts) {
        ...
        this.resultsArea.innerHTML = `<p class = "alert alert-danger text-center shadow-sm">Sorry we could not find any results for that result</p>`
      }
      this.hideLoaderIcon()
