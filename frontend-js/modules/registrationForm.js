...
export default class RegistrationForm {
    ...
    events() {
        ...
        //Only need to do something if the key pressed changes the values. let's create a reusable function
    ...
    usernameHandler() {
        // the skeleton that'll run some code immediately and the other after a delay
    ...
    usernameAfterDelay() {
        if (this.username.value.length < 3) {
            this.showValidationError(this.username, "Username must be at least three characters")
        }
        if (!this.username.errors) {
